...
public class UserCenterController {
    ...
    @ResponseBody
    public Result centerEditUIProfile(HttpServletRequest request, HttpServletResponse response, Model model,@RequestParam("id") String id,@RequestParam("cmsMember.education") String xueli,@RequestParam("cmsMember.phone") String phone,@RequestParam("radio-inline") String gender,@RequestParam("cmsName") String name) {
        return userCenterService.centerEditPF(id,name,gender,xueli,phone);
    }
